...
function LoginScreen({ onLogin }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#fff0f6", display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      <div style={{ width:"100%", maxWidth:820, display:"flex", borderRadius:20, overflow:"hidden", boxShadow:"0 8px 48px rgba(255,0,102,0.12)", border:"1px solid #f0d0dc" }}>

        {/* Left — form */}
        <div style={{ flex:1, background:"#ffffff", padding:"48px 40px", display:"flex", flexDirection:"column", justifyContent:"center" }}>
          <div style={{ marginBottom:40 }}>
            <div style={{ fontFamily:"Georgia,serif", fontSize:28, color:hp, letterSpacing:-1, marginBottom:6 }}>✦ Moli</div>
            <div style={{ fontSize:13, color:"#b0b0b0", letterSpacing:0.3 }}>Creator management for modern agencies</div>
          </div>

          <ErrorMsg msg={error} />

          <div style={{ marginBottom:16 }}>
            <label style={{ fontSize:11, fontWeight:700, color:"#999", textTransform:"uppercase", letterSpacing:0.8, display:"block", marginBottom:6 }}>Email</label>
            <input
              type="email" value={email} onChange={e => setEmail(e.target.value)}
              onKeyDown={e => e.key === "Enter" && handleLogin()}
              placeholder="you@agency.com"
              style={{ width:"100%", background:"#fdf6f8", border:"1.5px solid #f0d0dc", borderRadius:10, padding:"12px 14px", color:"#0a0a0a", fontSize:14, outline:"none", boxSizing:"border-box" }}
            />
          </div>
          <div style={{ marginBottom:8 }}>
            <label style={{ fontSize:11, fontWeight:700, color:"#999", textTransform:"uppercase", letterSpacing:0.8, display:"block", marginBottom:6 }}>Password</label>
            <input
          ...
          <div style={{ textAlign:"right", marginBottom:20 }}>
            <button style={{ background:"none", border:"none", color:hp, fontSize:12, cursor:"pointer", fontWeight:600 }}>Forgot password?</button>
          </div>
        ...
        <div style={{ width:240, background:hp, display:"flex", flexDirection:"column", justifyContent:"space-between", padding:32, position:"relative", overflow:"hidden" }}>
          ...
          <div style={{ position:"relative" }}>
            <div style={{ fontSize:14, color:"rgba(255,255,255,0.9)", fontWeight:700, marginBottom:4 }}>✦ Moli</div>
...
export default function MoliApp() {
  ...
  return <Moli userInfo={userInfo} onLogout={handleLogout} />;
}
