        ...
        <div style={{ width:240, background:`linear-gradient(135deg, ${hp} 0%, #cc0052 100%)`, display:"flex", flexDirection:"column", justifyContent:"space-between", padding:32, position:"relative", overflow:"hidden" }}>
          ...
          <div style={{ position:"relative" }}>
            {[
              ...
              <div key={i} style={{ display:"flex", alignItems:"center", gap:8, marginBottom:10, fontSize:12, color:"rgba(255,255,255,0.85)" }}>
                <div style={{ width:16, height:16, borderRadius:"50%", background:"rgba(255,255,255,0.2)", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
                  <svg width="8" height="6" viewBox="0 0 8 6"><path d="M1 3l2 2 4-4" stroke="#fff" strokeWidth="1.5" fill="none" strokeLinecap="round"/></svg>
                </div>
                {f}
              </div>
            ))}
            <div style={{ marginTop:20, borderTop:"1px solid rgba(255,255,255,0.2)", paddingTop:16 }}>
              ...
              <div style={{ fontSize:28, fontWeight:700, color:"#fff", lineHeight:1 }}>100+</div>
              <div style={{ fontSize:12, color:"rgba(255,255,255,0.6)" }}>creators worldwide</div>
            </div>
          </div>
        </div>
